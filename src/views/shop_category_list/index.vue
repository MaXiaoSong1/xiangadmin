<template>
  <div class="subject">
    ...
    <!-- table -->
    <el-table :data="getList" style="width: 95%">
      <el-table-column prop="name" width="700" />

      <el-table-column prop="推荐商品">
        <i style="color: #409eff; font-size: 12px">推荐商品</i>
      </el-table-column>
...
<script setup>
import { ref } from 'vue'
import { getAdministration } from '../../api/CommodityManagement/categoryList'
const getList = ref([])
